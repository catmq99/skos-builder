...
enumeratedClass = "BiospecimenCollectionMethod"
namespace = "biospecimen"
target_vocab = "AZBCM"
excel_workbook = 'PreSKOS_BiospecimenCollectionMethod_1.2.0.xlsx'
...
#     ns_data = Namespace('https://purl.astrazeneca.net/rd/data/' + ns + '/' + eClass + '/')
#     ns_vocab = Namespace('https://purl.astrazeneca.net/rd/vocab/' + ns + '/' + eClass + '/')
...
def main():
    ...
    output_file = enumeratedClass + '_cv.ttl'
